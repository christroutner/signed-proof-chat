...
const MASTER_MULTIADDR =
  '/ip4/127.0.0.1/tcp/5004/p2p/QmYJvpS25SFiZ6sjYn9N5vtyaXGQjLK5vTFYHBVZ4rdMdB'
const DB_ADDRESS =
  '/orbitdb/zdpuB2ntQvbyNBErEFuSgEJEDxWUeLaPr3daHq1m8vpaMjU2d/example4452'
...
const startClientNode = async () => {
  ...
  standard_input.on('data', async data => {
    ...
    if (data === 'exit\n') {
      ...
      const entry = {
        userName: userName,
        message: JSON.stringify(testObj, null, 2)
      }
      await db.add(entry)
